...
public class ModelPattedOcelot extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (Utilities.getJoyFromEntity(entityIn) == 0) return;
        this.ocelotHead.rotateAngleX = MathHelper.sin(ageInTicks) * .2F;
        this.ocelotHead.rotateAngleZ = MathHelper.cos(ageInTicks) * .01F;
        this.ocelotHead.rotateAngleY = MathHelper.cos(ageInTicks) * .01F;
        this.ocelotTail2.rotateAngleX = 2.670354F + MathHelper.sin(ageInTicks) * .2F;
        this.ocelotTail2.rotateAngleZ = MathHelper.cos(ageInTicks) * .02F;
        this.ocelotTail2.rotateAngleY = MathHelper.cos(ageInTicks) * .02F;
    }

    public void setLivingAnimations(EntityLivingBase l, float limbSwing, float limbSwingAmount, float partialTickTime) {
        EntityOcelot ocelot = (EntityOcelot) l;
