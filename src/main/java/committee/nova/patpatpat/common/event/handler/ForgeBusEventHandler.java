...
public class ForgeBusEventHandler {
    ...
    public static void onPat(AttackEntityEvent e) {
        ...
        if (!e.getEntity().isShiftKeyDown() || !(PattableManager.isPattable(l))) return;
        e.setCanceled(true);
