...
public class PattedCatCollarFeature extends FeatureRenderer<CatEntity, PattedCatModel<CatEntity>> {
    ...
    public PattedCatCollarFeature(FeatureRendererContext<CatEntity, PattedCatModel<CatEntity>> ctx, EntityModelLoader d) {
        super(ctx);
        this.model = new PattedCatModel<>(d.getModelPart(EntityModelLayers.CAT));
    }
