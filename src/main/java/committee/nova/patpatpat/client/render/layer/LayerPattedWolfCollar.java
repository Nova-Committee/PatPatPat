...
public class LayerPattedWolfCollar implements LayerRenderer<EntityWolf> {
    ...
    @Override
    public void render(EntityWolf wolf, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
